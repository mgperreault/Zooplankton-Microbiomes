...
# Shannon diversity
zoop.comm.div <- vegan::diversity(counts[,c(20:31)], index="shannon")
...
summary(lm(daphnia.dens ~  DO..perc + DOC + Chlorophyll.1..ug.L. + pH + cond + temp..C, data = counts))
summary(lm(cal.dens ~  DO..perc + DOC + Chlorophyll.1..ug.L. + pH + cond + temp..C, data = counts))
summary(lm(cyc.dens ~  DO..perc + DOC + Chlorophyll.1..ug.L. + pH + cond + temp..C, data = counts))
summary(lm(nau.dens ~  temp..C + DOC + Chlorophyll.1..ug.L. + pH + DO..perc + cond, data = counts))
summary(lm(bos.dens ~  temp..C + DOC + Chlorophyll.1..ug.L. + pH + DO..perc + cond, data = counts))
summary(lm(ker.dens ~  temp..C + DOC + Chlorophyll.1..ug.L. + pH + DO..perc + cond, data = counts))
summary(lm(kell.dens ~  temp..C + DOC + Chlorophyll.1..ug.L. + pH + DO..perc + cond, data = counts))
```
