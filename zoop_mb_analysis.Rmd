...
env.hell <- sample_data(PS.hell)[ ,c(8:18)]
...
lake_colors <- c("blue","red", "purple2", "turquoise", "lightpink",  "orange")
lake.group <- nmds.merge.hell$lake


### make plot by habitat with vectors for environment
environm_plot <- ordiplot(nmds.merge.hell[,c(26,27)], type="n", main=substitute(paste("")), cex.main=1, display="sites", cex.lab=0.8, cex.axis=0.8)
abline(h = 0, lty = "dotted")
abline(v = 0, lty = "dotted")
points(nmds.hell, "sites", cex=0.8, pch=16, col = "gray45")
ordihull(environm_plot, groups=nmds.merge.hell$lake, draw="polygon", alpha=100, col = lake_colors)
