...
view(Bacteroidia)
summary(lm(Abundance.sum ~ lake + time_point + phy_group, data = Bacteroidia))
...
summary(lm(Abundance.sum ~ lake + time_point + phy_group, data = gammaproteobacteria))
...
summary(lm(Abundance.sum ~ lake + time_point + phy_group, data = alphaproteobacteria))
# lake is important
...
summary(lm(Abundance.sum ~ lake + time_point + phy_group, data = actinobacteria))
# lake is important
...
summary(lm(Abundance.sum ~ lake + time_point + phy_group, data = cyanobacteriia))
# lake is important
