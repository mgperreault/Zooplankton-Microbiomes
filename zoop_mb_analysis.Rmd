...
```{r Hellinger transformation --> THIS IS WHAT I WILL USE FOR ANALYSIS}
...
elevations
dev.copy(pdf, "phyloseq analysis/figures/elevations.pdf", height=5, width=5)
dev.off()
```
