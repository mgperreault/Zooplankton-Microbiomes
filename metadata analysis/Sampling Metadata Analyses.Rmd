...
chla.plot<- ggplot(chla.df, aes(x= Time.Sample, y=Chlorophyll.1..ug.L, group=Lake, color=Lake)) + geom_line() + scale_color_brewer(type = "qual", palette = "Dark2") + xlab("Sampling Time Point") + theme(axis.text = element_text(size=7)) +  ylab(expression(paste("Chlorophyll-a", ~(mu*g~ L^-1), sep = "")))
...
DO.percent.plot<-ggplot(lakeDO.df, aes(x=Time.Point, y=DO..perc, group=Lake, color=Lake)) + geom_line() + scale_color_brewer(type = "qual", palette = "Dark2") + xlab("Sampling Time Point") + ylab("DO (%)")
...
conductivity.plot<-ggplot(lakeCond.df, aes(x=Time.Point, y=cond, group=Lake, color=Lake)) + geom_line() + scale_color_brewer(type = "qual", palette = "Dark2") + xlab("Sampling Time Point") + ylab("Conductivity(S)")
...
pH.plot<-ggplot(lakepH.df, aes(x=Time.Point, y=pH, group=Lake, color=Lake)) + geom_line() + scale_color_brewer(type = "qual", palette = "Dark2") + xlab("Sampling Time Point")
...
laketemp.plot<-ggplot(laketemp.df, aes(x=Time.Point, y=temp..C, group=Lake, color=Lake)) + geom_line() + scale_color_brewer(type = "qual", palette = "Dark2") + xlab("Sampling Time Point") + ylab("Temperature (°C)")
...
chla.plot + DO.percent.plot + conductivity.plot + pH.plot + laketemp.plot + TotalAlkalinity.plot + TN.plot + TP.plot + DOC.plot + plot_layout(guides="collect") 

ggarrange(DOC.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), chla.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), DO.percent.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), conductivity.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), pH.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), laketemp.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), TP.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), TN.plot + rremove("xlab") + theme(axis.title.y=element_text(size=8)), plot_layout(guides="collect"), labels=NULL, common.legend = TRUE, legend="bottom", align="hv", font.label = list(size=10, color="black", family=NULL, position="top", labels="auto"))
...
log.DOC.plot + DO.percent.plot + pH.plot + laketemp.plot + plot_layout(guides="collect")


ggarrange(log.DOC.plot, DO.percent.plot, pH.plot, laketemp.plot, label.x = "Sampling Time Point", common.legend = TRUE, legend="bottom", nrow = 2, ncol = 2)
