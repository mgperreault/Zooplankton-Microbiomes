...
weather <- data.frame(Dates = TimePoint, Temperature = avg.temp, Precipitation = rain.total)


weather.plot <- ggplot(weather, aes(x=fct_inorder(TimePoint))) +
  geom_line(aes(y=Temperature, group=1, color="Temperature"), size=1.5) + 
  geom_line(aes(y=Precipitation, group=1, color="Precipitation"), size=1.5) +
